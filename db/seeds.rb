...
u2.profile.update_attributes(
  ...
  interested_in_age_start: 20,
  interested_in_age_end: 30,
  city: "London",
...
u11.profile.update_attributes(
  ...
  gender: "female",
  interested_in_gender: "male",
  interested_in_age_start: 30,
  interested_in_age_end: 40,
  city: "London",
